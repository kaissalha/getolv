...
const MenuCheckboxItem = ({ className, children, checked, ...props }: MenuPrimitive.CheckboxItem.Props) => {
	return (
...
const MenuRadioItem = ({ className, children, ...props }: MenuPrimitive.RadioItem.Props) => {
	return (
