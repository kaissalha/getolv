...
const navigationMenuTriggerStyle = cva(
	"outline-ring/50 ring-ring/10 focus:text-accent-foreground data-[state=open]:text-accent-foreground dark:outline-ring/40 dark:ring-ring/20 group inline-flex h-9 w-max items-center justify-center rounded-md px-4 py-2 font-medium transition-[color,box-shadow] focus-visible:outline-1 focus-visible:ring-4 disabled:pointer-events-none disabled:opacity-50"
);
...
const NavigationMenuLink = ({ className, ...props }: React.ComponentProps<typeof NavigationMenuPrimitive.Link>) => {
	return (
		<NavigationMenuPrimitive.Link
			...
			className={cn(
				"outline-ring/50 ring-ring/10 hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground data-[active=true]:bg-accent/50 data-[active=true]:text-accent-foreground data-[active=true]:hover:bg-accent data-[active=true]:focus:bg-accent dark:outline-ring/40 dark:ring-ring/20 [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm p-2 transition-[color,box-shadow] focus-visible:outline-1 focus-visible:ring-4 [&_svg:not([class*='size-'])]:size-4",
				className
			)}
			{...props}
		/>
