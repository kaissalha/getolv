...
import { buildMailClassificationPrompt, mailThreadClassificationSchema } from "@getolv/ai/prompts";
...
evalite<MailClassificationInput, MailClassificationOutput, MailClassificationExpected>("Mail classification prompt", {
	data: [
		{
			input: {
				connectionEmail: "clinician@example.com",
				threads: [
					{
						id: "thread-respond",
						sender: {
						...
						snippet: "Thanks for the plan. Can you confirm whether I should start the iron today?",
						subject: "Question about supplement timing",
					},
					{
						id: "thread-marketing",
						sender: {
						...
						snippet: "Spring sale: save 30% on practitioner-grade sample kits this week only.",
						subject: "Limited time supplies offer",
					},
					{
						id: "thread-meeting",
						sender: {
						...
						snippet: "The appointment was moved from 2:00 PM to 3:30 PM. Updated joining details attached.",
						subject: "Updated invitation: Maya Lin follow-up",
					},
				],
			},
			expected: {
			...
			input: {
				...
				threads: [
					...
					},
					{
						...
						snippet: "Sharing the article we discussed. No action needed, just thought it was useful.",
