		...
		>
			<div className='flex flex-col gap-32'>
				<div className='flex flex-col items-start gap-6'>
					...
					>
						<span className='truncate'>Oatmeal raises 80M Series A funding</span>
						<span className='h-3 w-px bg-olive-950/20' />
						<span className='inline-flex shrink-0 items-center gap-2 font-semibold'>
							Learn more <ChevronRight className='size-3' strokeWidth={1.5} />
						</span>
					</Link>
					...
					<div className='text-lg text-olive-700 flex max-w-3xl flex-col gap-4'>
						<p>
							Simplify your shared inbox, collaborate effortlessly, and give every customer a reply that
							feels personal — even if it was generated by a bot.
						</p>
					</div>
