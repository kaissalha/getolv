...
import { CalendarIcon, HomeIcon, MailIcon, StickyNoteIcon, UsersIcon } from "lucide-react";
...
export const NavMain = () => {
	...
	const items = useMemo(
		() => [
			...
			{
				title: t("breadcrumbs.patients"),
				url: "/dashboard/patients",
				icon: UsersIcon,
				exactMatch: false,
			},
			{
				title: t("breadcrumbs.notes"),
				url: "/dashboard/notes",
				icon: StickyNoteIcon,
				exactMatch: false,
			},
			{
				title: t("breadcrumbs.mail"),
				url: "/dashboard/mail",
				icon: MailIcon,
				exactMatch: false,
			},
			{
				title: t("breadcrumbs.calendar"),
